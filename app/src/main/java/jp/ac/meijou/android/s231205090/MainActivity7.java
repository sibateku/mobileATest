...
import jp.ac.meijou.android.s231205090.databinding.ActivityMain7Binding;
...
public class MainActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateTransport(activeNetwork);
        updateIpAddress(activeNetwork);
    }
    ...
    private void updateIpAddress(Network network) {
        ...
        if (linkProperties != null) {
            ...
            binding.textIP.setText(addresses);
        }
    }
}